...
export const Product = component$(() => {
    ...
    return (
        <section id="productos" class="grid grid-cols-12 p-10 gap-4 ">
            ...
            <div
                class={`col-span-12 md:col-span-7 order-first md:order-last opacity-0 ${
                    animate.value
                        ? "transition-all animate-show-on-scroll-left"
                        : ""
                }`}
            >
                ...
                <p class="mb-6 text-lg font-medium text-gray-500 dark:text-gray-400">
                    Con Seifen puedes ahorrar más detergente y espacio en tu
                    hogar, con tan solo 5ml de Seifen puedes lavar hasta 5kg de
                    ropa.
                    <br /> <br />
