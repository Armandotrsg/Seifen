...
export const CardSection = component$(() => {
    return (
        <section class={"bg-slate-100 dark:bg-gray-800 flex justify-center pb-16"}>
            <div class="w-[95%] p-4 text-center bg-slate-200 border border-gray-200 rounded-xl shadow-xl sm:p-8 dark:bg-gray-900 dark:border-gray-700 shadow-gray-400 dark:shadow-black">
